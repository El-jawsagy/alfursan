import 'package:al_fursan/category/category.dart';
              ...
              builder: (BuildContext context, AsyncSnapshot snapShot) {
                switch (snapShot.connectionState) {
                  case ConnectionState.none:
                    return Container(
                      child: similarWidgets.noConnection(context, .85, .35),
                    );
                    break;
                  case ConnectionState.waiting:
                    return similarWidgets.loading(context, 0.85, .35);
                    break;
                  ...
                  case ConnectionState.done:
                    if (snapShot.hasError) {
                      ...
                      if (snapShot.hasData) {
                        ...
                        return _drawCategoriesWithImage(categories);
