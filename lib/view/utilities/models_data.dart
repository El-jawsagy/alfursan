...
List<Page> allAppPages(bool language) {
  ...
  pages.add(Page(
      language ? "التذاكر" : "Tickets", '/home', FontAwesomeIcons.ticketAlt));
  pages.add(
      Page(language ? "الرحلات" : "Tours", '/home', FontAwesomeIcons.plane));
  pages.add(Page(
      language ? "تاشيرات الدخول" : "Visa", '/home', FontAwesomeIcons.ccVisa));
...
//function to built list of pages and return it in MainScreen screen to use it
List<Page> navigationPages() {
  List<Page> pages = [];
  pages.add(Page("Home", '/home', FontAwesomeIcons.home));
  pages.add(Page("Tickets", '/home', FontAwesomeIcons.ticketAlt));
  pages.add(Page("Tours", '/home', FontAwesomeIcons.plane));
  return pages;
}
